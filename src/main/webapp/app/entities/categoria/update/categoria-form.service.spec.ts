...
describe('Categoria Form Service', () => {
  ...
  describe('Service methods', () => {
      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            idCategoriaPadre: expect.any(Object),
            ...
            categorieFiglie: expect.any(Object),
          })
        );
      });
    ...
    describe('resetForm', () => {
      it('passing ICategoria should not enable idCategoria FormControl', () => {
        const formGroup = service.createCategoriaFormGroup();
        expect(formGroup.controls.idCategoria.disabled).toBe(true);
      ...
      it('passing NewCategoria should disable idCategoria FormControl', () => {
        const formGroup = service.createCategoriaFormGroup(sampleWithRequiredData);
        expect(formGroup.controls.idCategoria.disabled).toBe(true);

        service.resetForm(formGroup, { idCategoria: null });
