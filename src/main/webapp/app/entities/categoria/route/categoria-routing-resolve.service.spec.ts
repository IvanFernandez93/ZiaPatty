...
describe('Categoria routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return ICategoria returned by find', () => {
      // GIVEN
      service.find = jest.fn(idCategoria => of(new HttpResponse({ body: { idCategoria } })));
      mockActivatedRouteSnapshot.params = { idCategoria: 123 };
      ...
      expect(resultCategoria).toEqual({ idCategoria: 123 });
    });
