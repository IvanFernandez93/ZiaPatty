...
describe('Audio Form Service', () => {
  ...
  describe('Service methods', () => {
    ...
    describe('resetForm', () => {
      it('passing IAudio should not enable idAudio FormControl', () => {
        const formGroup = service.createAudioFormGroup();
        expect(formGroup.controls.idAudio.disabled).toBe(true);
      ...
      it('passing NewAudio should disable idAudio FormControl', () => {
        const formGroup = service.createAudioFormGroup(sampleWithRequiredData);
        expect(formGroup.controls.idAudio.disabled).toBe(true);

        service.resetForm(formGroup, { idAudio: null });
