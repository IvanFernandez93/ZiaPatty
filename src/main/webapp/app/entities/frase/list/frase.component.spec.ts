...
describe('Frase Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'frase', component: FraseComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.frases?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to fraseService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getFraseIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getFraseIdentifier).toHaveBeenCalledWith(entity);
